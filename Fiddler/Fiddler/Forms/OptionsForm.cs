...
namespace Fiddler.Forms
{
    public partial class OptionsForm : Form
    {
            ...
            Action updateMapTabAction)
        {
            ...
            checkBoxSuppressCopyPasteWarnings.Checked = Options.SuppressCopyPasteWarnings;
        ...
        private void OnClickApply(object sender, EventArgs e)
        {
            ...
            Options.SuppressCopyPasteWarnings = checkBoxSuppressCopyPasteWarnings.Checked;
