...
namespace Fiddler.Controls.Classes
{
    public static class Options
    {
        ...
        /// <summary>
        /// When true, the "Image copied" and "Are you sure you want to paste?"
        /// confirmations in the Items tab are skipped. Default false = warnings shown.
        /// </summary>
        public static bool SuppressCopyPasteWarnings { get; set; }
        ...
        {
            return new Icon(System.Reflection.Assembly.GetEntryAssembly().GetManifestResourceStream("Fiddler.Resources.FiddlerIcon.ico"));
        }
        ...
        static Options()
        {
            AppDataPath = Path.Combine(
                System.Environment.GetFolderPath(System.Environment.SpecialFolder.ApplicationData), "Fiddler");
        }
    }
}
