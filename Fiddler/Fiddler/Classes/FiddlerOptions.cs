...
namespace Fiddler.Classes
{
    public static class FiddlerOptions
    {
        ...
        public static void SaveProfile()
        {
            ...
            sr.AppendChild(elem);
            elem = dom.CreateElement("SuppressCopyPasteWarnings");
            elem.SetAttribute("active", Options.SuppressCopyPasteWarnings.ToString());
            sr.AppendChild(elem);
        ...
        public static void LoadProfile(string filename)
        {
            ...
            elem = (XmlElement)xOptions.SelectSingleNode("SuppressCopyPasteWarnings");
            if (elem != null)
            {
                Options.SuppressCopyPasteWarnings = bool.Parse(elem.GetAttribute("active"));
            }
