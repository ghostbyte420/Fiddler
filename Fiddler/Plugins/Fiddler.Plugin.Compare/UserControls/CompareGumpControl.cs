...
namespace Fiddler.Plugin.Compare.UserControls
{
    public partial class CompareGumpControl : UserControl
    {
        ...
        private void Export_Bmp(object sender, EventArgs e)
        {
            ...
            string fileName = Path.Combine(path, $"Gump(Sec) {Fiddler.Controls.Classes.Utils.FormatExportId(i)}.bmp");
        ...
        private void Export_Tiff(object sender, EventArgs e)
        {
            ...
            string path     = Options.OutputPath;
            string fileName = Path.Combine(path, $"Gump(Sec) {Fiddler.Controls.Classes.Utils.FormatExportId(i)}.tiff");
        ...
        private void Export_Jpg(object sender, EventArgs e)
        {
            ...
            string path     = Options.OutputPath;
            string fileName = Path.Combine(path, $"Gump(Sec) {Fiddler.Controls.Classes.Utils.FormatExportId(i)}.jpg");
        ...
        private void Export_Png(object sender, EventArgs e)
        {
            ...
            string path     = Options.OutputPath;
            string fileName = Path.Combine(path, $"Gump(Sec) {Fiddler.Controls.Classes.Utils.FormatExportId(i)}.png");
