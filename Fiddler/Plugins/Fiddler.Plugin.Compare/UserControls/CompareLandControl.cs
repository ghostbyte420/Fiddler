...
using Fiddler.Plugin.Compare.Classes;
...
namespace Fiddler.Plugin.Compare.UserControls
{
    public partial class CompareLandControl : UserControl
    {
        ...
        private void ExportAsBmp(object sender, EventArgs e)
        {
            ...
            string fileName = Path.Combine(Options.OutputPath, $"Landtile(Sec) {Fiddler.Controls.Classes.Utils.FormatExportId(i)}.bmp");
        ...
        private void ExportAsTiff(object sender, EventArgs e)
        {
            ...
            string fileName = Path.Combine(Options.OutputPath, $"Landtile(Sec) {Fiddler.Controls.Classes.Utils.FormatExportId(i)}.tiff");
        ...
        private void ExportAsJpg(object sender, EventArgs e)
        {
            ...
            string fileName = Path.Combine(Options.OutputPath, $"Landtile(Sec) {Fiddler.Controls.Classes.Utils.FormatExportId(i)}.jpg");
        ...
        private void ExportAsPng(object sender, EventArgs e)
        {
            ...
            string fileName = Path.Combine(Options.OutputPath, $"Landtile(Sec) {Fiddler.Controls.Classes.Utils.FormatExportId(i)}.png");
