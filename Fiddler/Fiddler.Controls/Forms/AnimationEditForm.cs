...
namespace Fiddler.Controls.Forms
{
    public partial class AnimationEditForm : Form
    {
        ...
        public AnimationEditForm()
        {
            ...
            // >>> ADD START — create the Gallery tile view (the designer never made it, so it was null and crashed)
            GalleryTileView = new Fiddler.Controls.UserControls.TileView.TileViewControl
            {
                Dock = DockStyle.Fill,
                Name = "GalleryTileView",
                TabStop = true,
        ...
        private void OnLoad(object sender, EventArgs e)
        {
            ...
            // Guard: only touch the gallery view once it has been created.
            if (GalleryTileView != null)
            {
        ...
        private void GalleryTileViewDrawItem(object sender, Fiddler.Controls.UserControls.TileView.TileViewControl.DrawTileListItemEventArgs e)
        {
